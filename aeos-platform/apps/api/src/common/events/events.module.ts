...
import {
  ...
  WorkspaceMemberInvitedIntegrationEvent,
...
export class EventsModule {
  constructor() {
    ...
    EventRegistry.register(
      ProjectCreatedIntegrationEvent.EVENT_TYPE,
      ProjectCreatedIntegrationEvent,
    );
    EventRegistry.register(
      ProjectDeletedIntegrationEvent.EVENT_TYPE,
      ProjectDeletedIntegrationEvent,
    );
    EventRegistry.register(
      DocumentCreatedIntegrationEvent.EVENT_TYPE,
      DocumentCreatedIntegrationEvent,
    );
    EventRegistry.register(
      DocumentDeletedIntegrationEvent.EVENT_TYPE,
      DocumentDeletedIntegrationEvent,
    );
    ...
    EventRegistry.register(
      ApprovalCreatedIntegrationEvent.EVENT_TYPE,
      ApprovalCreatedIntegrationEvent,
    );
    EventRegistry.register(
      ApprovalDeletedIntegrationEvent.EVENT_TYPE,
      ApprovalDeletedIntegrationEvent,
    );
    EventRegistry.register(
      CommentCreatedIntegrationEvent.EVENT_TYPE,
      CommentCreatedIntegrationEvent,
    );
    EventRegistry.register(
      CommentDeletedIntegrationEvent.EVENT_TYPE,
      CommentDeletedIntegrationEvent,
    );
    EventRegistry.register(
      WorkspaceMemberAddedIntegrationEvent.EVENT_TYPE,
      WorkspaceMemberAddedIntegrationEvent,
    );
    EventRegistry.register(
      WorkspaceMemberRemovedIntegrationEvent.EVENT_TYPE,
      WorkspaceMemberRemovedIntegrationEvent,
    );
    EventRegistry.register(
      WorkspaceMemberInvitedIntegrationEvent.EVENT_TYPE,
      WorkspaceMemberInvitedIntegrationEvent,
    );
  }
}
