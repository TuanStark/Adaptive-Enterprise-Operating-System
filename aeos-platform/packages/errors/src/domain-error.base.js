...
exports.ValidationError = exports.ForbiddenError = exports.ConflictError = exports.NotFoundError = exports.DomainError = void 0;
class DomainError {
    code;
    message;
    httpStatus;
...
class ForbiddenError extends DomainError {
    constructor(action) {
        super('INSUFFICIENT_PERMISSION', action ? `You do not have permission to: ${action}` : 'Access denied.', 403);
    }
}
